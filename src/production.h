...
PRODUCTION production[] = {
		...
		{3,"func->ret_type id M_func_start (){func_content}",8,null_f},
		{3,"func->ret_type id M_func_start (param_list){func_content}",9,null_f},
		...
		{15,"d_array->t_type id [num]",5,null_f},
		{15,"d_array->t_type id [num]={d_array_list}",9,null_f},
