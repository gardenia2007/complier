...
PRODUCTION production[] = {
		...
		{9,"d_param_list->d_param_item d_param_list",1,null_f},
		{9,"d_param_list->d_param_item",1,null_f},
		{9,"d_param_list->, d_param_list",2,null_f},
		{10,"d_param_item->id [ ]",3,null_f},
		{10,"d_param_item->id",1,null_f},
		{10,"d_param_item->num",1,null_f},
		{7,"param_list->param_item param_list",2,null_f},
		{7,"param_list->param_item",1,null_f},
		{7,"param_list->, param_list",2,null_f},
		{8,"param_item->t_type M_t_type id [ ]",5,null_f},
		{8,"param_item->t_typeM_t_typeid",3,null_f},
		{38,"M_t_type->E",0,null_f},
		{18,"declare->declare semi t_type id",4,null_f},
		{18,"declare->t_typeid",2,null_f},
		...
		{11,"t_type->type",1,null_f},
		{13,"type->float",1,null_f},
		{13,"type->bool",1,null_f},
		{13,"type->char",1,null_f},
		{13,"type->int",1,null_f},
		...
		{40,"M_func_content_declare->E",0,null_f},
		...
		{30,"call_func->id()",3,null_f},
		{30,"call_func->id(d_param_list)",4,null_f},
		{19,"exp->var=exp_item",3,null_f},
		{19,"exp->var=call_func",3,null_f},
		{19,"exp->call_func",1,null_f},
		{36,"var->id[exp_item]",4,null_f},
		{36,"var->id",1,null_f},
		{20,"exp_item->exp_item addop term",3,null_f},
		{20,"exp_item->term",1,null_f},
		{21,"term->term mulop factor",3,null_f},
		{21,"term->factor",1,null_f},
		{22,"factor->num",1,null_f},
		{22,"factor->ch",1,null_f},
		{22,"factor->id",1,null_f},
		{22,"factor->id[exp_item]",4,null_f},
		{22,"factor->(exp_item)",3,null_f},
